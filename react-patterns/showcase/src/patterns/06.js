import React, {Component, useCallback, useLayoutEffect ,useEffect, useState, useRef} from 'react';
...
const animationTimeline = useClapAnimation({
 ...
 return <button ref={setRef} data-refkey="clapRef" className={styles.clap} onClick={updateClapState}>
