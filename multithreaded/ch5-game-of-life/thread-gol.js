...
if (isMainThread) {
    ...
    for (let i = 0; i < THREADS; i ++) {
        ...
        worker.postMessage({
            range: [0, chunkSize * i, SIZE, chunkSize * (i + 1)], sharedMemory,
            i
        });
    }
